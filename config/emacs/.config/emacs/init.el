...
(add-hook 'org-mode-hook 'variable-pitch-mode)
  ...
  (use-package org
    ...
    (org-agenda-files '("inbox.org" "repeaters.org" "/home/cognusboi/workspace/userfiles/college/3-2/classes.org"))
    ...
    (setq org-capture-templates
          '(
			...
			("tg" "General" entry
             ...
             "* TODO %^{Enter Todo}\n SCHEDULED: %^t \n %?")
			("ta" "Academics" entry
			 (file "~/workspace/userfiles/college/3-2/classes.org")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(link gitignore-snippets yasnippet-snippets ado-mode zig-mode yaml-mode which-key web-mode vterm visual-fill-column vertico-posframe use-package tree-sitter-langs test-simple svelte-mode rustic rg redis rainbow-delimiters python-mode projectile prettier-js ox-reveal org-roam-ui org-ref org-modern org-bullets orderless openwith no-littering nim-mode nasm-mode marginalia magit lua-mode lsp-ui lsp-tailwindcss lsp-java loc-changes load-relative java-snippets helpful haskell-mode graphviz-dot-mode go-mode general evil-collection eterm-256color ess emmet-mode dotenv-mode doom-themes doom-modeline dashboard corfu consult company-box cdlatex catppuccin-theme beacon auctex all-the-icons))
