...
var VsCodeClientWorkspace = /*#__PURE__*/function () {
  function VsCodeClientWorkspace(connection, config, documents, notebooks, logger) {
    ...
    documents.onDidOpen(function (e) {
      ...
      _this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: TextDocument.onDidOpen', "".concat(e.document.uri));
    ...
    documents.onDidChangeContent(function (e) {
      ...
      _this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: TextDocument.onDidChanceContent', "".concat(e.document.uri));
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: TextDocument.onDidClose', "".concat(e.document.uri));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                _this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: onDidChangeWatchedFiles', "".concat(change.type, ": ").concat(resource));
    ...
    connection.onRequest(protocol.fs_watcher_onChange, function (params) {
      _this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: fs_watcher_onChange', "".concat(params.kind, ": ").concat(params.uri));
  ...
  _createClass(VsCodeClientWorkspace, [{
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 3:
                return _context8.abrupt("return", this.connection.sendRequest(protocol.fs_stat, {
                  uri: resource.toString()
                }));
    ...
    key: "readDirectory",
    value: function () {
      var _readDirectory = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(resource) {
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: readDir', "".concat(resource));
                return _context9.abrupt("return", this.connection.sendRequest(protocol.fs_readDirectory, {
                  uri: resource.toString()
                }));
    ...
    value: function watchFile(resource, options) {
      ...
      this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: watchFile', "(".concat(id, ") ").concat(resource));
      var entry = {
        resource: resource,
        options: options,
      ...
      return {
        ...
        dispose: function dispose() {
          _this4.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: disposeWatcher', "(".concat(id, ") ").concat(resource));
    ...
    value: function doDeleteDocument(uri) {
      this.logger.log(md.LogLevel.Trace, 'VsCodeClientWorkspace: deleteDocument', "".concat(uri));
