...
function startServer(connection, runtime) {
  ...
  connection.onDidChangeConfiguration(function (change) {
    var _runtime$configureHtt, _settings$http, _settings$http2, _settings$json, _settings$json2, _settings$json2$valid, _settings$json3, _settings$json3$keepL, _settings$json4, _settings$json5, _settings$json6;
    ...
    jsoncFoldingRangeLimit = sanitizeLimitSetting(((_settings$json6 = settings.json) === null || _settings$json6 === void 0 ? void 0 : _settings$json6.jsoncFoldingLimit) || foldingRangeLimitDefault); // dynamically enable & disable the formatter

    if (dynamicFormatterRegistration) {
      var _settings$json7, _settings$json7$forma;

      var enableFormatter = (_settings$json7 = settings.json) === null || _settings$json7 === void 0 ? void 0 : (_settings$json7$forma = _settings$json7.format) === null || _settings$json7$forma === void 0 ? void 0 : _settings$json7$forma.enable;
