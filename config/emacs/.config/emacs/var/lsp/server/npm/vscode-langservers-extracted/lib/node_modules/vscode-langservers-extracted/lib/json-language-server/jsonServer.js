...
function startServer(connection, runtime) {
  ...
  connection.onDidChangeConfiguration(function (change) {
    var _runtime$configureHtt, _settings$http, _settings$http2, _settings$json, _settings$json2, _settings$json2$valid, _settings$json3, _settings$json3$keepL, _settings$json4, _settings$json5;
    ...
    updateConfiguration();
    foldingRangeLimit = Math.trunc(Math.max(((_settings$json4 = settings.json) === null || _settings$json4 === void 0 ? void 0 : _settings$json4.resultLimit) || foldingRangeLimitDefault, 0));
    resultLimit = Math.trunc(Math.max(((_settings$json5 = settings.json) === null || _settings$json5 === void 0 ? void 0 : _settings$json5.resultLimit) || Number.MAX_VALUE, 0)); // dynamically enable & disable the formatter

    if (dynamicFormatterRegistration) {
      var _settings$json6, _settings$json6$forma;

      var enableFormatter = (_settings$json6 = settings.json) === null || _settings$json6 === void 0 ? void 0 : (_settings$json6$forma = _settings$json6.format) === null || _settings$json6$forma === void 0 ? void 0 : _settings$json6$forma.enable;
  ...
  function validateTextDocument(_x3) {
    return _validateTextDocument.apply(this, arguments);
  }

  function _validateTextDocument() {
    _validateTextDocument = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(textDocument) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              jsonDocument = getJSONDocument(document);
              return _context3.abrupt("return", languageService.doComplete(document, textDocumentPosition.position, jsonDocument));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              jsonDocument = getJSONDocument(document);
              return _context4.abrupt("return", languageService.doHover(document, textDocumentPositionParams.position, jsonDocument));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              jsonDocument = getJSONDocument(document);
              return _context5.abrupt("return", languageService.findDocumentColors(document, jsonDocument, {
                resultLimit: resultLimit
              }));
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              jsonDocument = getJSONDocument(document);
              return _context6.abrupt("return", languageService.findLinks(document, jsonDocument));
