...
NoLinkRanges.empty = new NoLinkRanges([], new Map());
/**
...
class LinkDefinitionSet {
    constructor(links) {
        this._map = new ReferenceLinkMap();
...
class MdLinkProvider extends dispose_1.Disposable {
    constructor(_config, tokenizer, _workspace, _tocProvider, logger) {
        ...
        this._linkCache = this._register(new workspaceCache_1.MdDocumentInfoCache(this._workspace, async (doc, token) => {
