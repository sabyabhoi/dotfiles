...
function _startVsCodeServer() {
  _startVsCodeServer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(connection) {
    var logger, parser, documents, notebooks, workspaceFactory;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            logger = new logging_1.LogFunctionLogger(connection.console.log.bind(connection.console));
            ...
            workspaceFactory = function workspaceFactory(_ref2) {
              var connection = _ref2.connection,
                  config = _ref2.config,
                  workspaceFolders = _ref2.workspaceFolders;
            ...
            return _context2.abrupt("return", startServer(connection, {
              documents: documents,
              notebooks: notebooks,
              logger: logger,
              parser: parser,
        ...
        switch (_context19.prev = _context19.next) {
          case 0:
            ...
            connection.onInitialize(function (params) {
              ...
              var config = (0, config_1.getLsConfiguration)(initOptions !== null && initOptions !== void 0 ? initOptions : {});
              var configurationManager = new configuration_1.ConfigurationManager(connection);
              ...
              (0, diagnostics_1.registerValidateSupport)(connection, workspace, documents, mdLs, configurationManager, serverConfig.logger);
              return {
                capabilities: {
                  diagnosticProvider: {
            ...
            connection.onDocumentLinks( /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(params, token) {
                var document;
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 3:
                        return _context3.abrupt("return", mdLs.getDocumentLinks(document, token));
            ...
            connection.onDocumentLinkResolve( /*#__PURE__*/function () {
              var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(link, token) {
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        return _context4.abrupt("return", mdLs.resolveDocumentLink(link, token));
            ...
            connection.onDocumentSymbol( /*#__PURE__*/function () {
              var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(params, token) {
                var document;
                return regeneratorRuntime.wrap(function _callee5$(_context5) {
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      ...
                      case 3:
                        return _context5.abrupt("return", mdLs.getDocumentSymbols(document, {
                ...
                return regeneratorRuntime.wrap(function _callee6$(_context6) {
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      ...
                      case 3:
                        return _context6.abrupt("return", mdLs.getFoldingRanges(document, token));
                ...
                return regeneratorRuntime.wrap(function _callee7$(_context7) {
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      ...
                      case 3:
                        return _context7.abrupt("return", mdLs.getSelectionRanges(document, params.positions, token));
                ...
                return regeneratorRuntime.wrap(function _callee8$(_context8) {
                  while (1) {
                    switch (_context8.prev = _context8.next) {
                      case 0:
                        return _context8.abrupt("return", mdLs.getWorkspaceSymbols(params.query, token));
                ...
                return regeneratorRuntime.wrap(function _callee9$(_context9) {
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      ...
                      case 3:
                        return _context9.abrupt("return", mdLs.getReferences(document, params.position, params.context, token));
                ...
                return regeneratorRuntime.wrap(function _callee10$(_context10) {
                  while (1) {
                    switch (_context10.prev = _context10.next) {
                      ...
                      case 3:
                        return _context10.abrupt("return", mdLs.getDefinition(document, params.position, token));
                  ...
                  while (1) {
                    switch (_context11.prev = _context11.next) {
                      ...
                      case 9:
                        ...
                        if (!(_context11.t0 instanceof md.RenameNotSupportedAtLocationError)) {
                          _context11.next = 15;
                          break;
                        }

                        throw new vscode_languageserver_1.ResponseError(0, _context11.t0.message);
                ...
                return regeneratorRuntime.wrap(function _callee12$(_context12) {
                  while (1) {
                    switch (_context12.prev = _context12.next) {
                      ...
                      case 3:
                        return _context12.abrupt("return", mdLs.getRenameEdit(document, params.position, params.newName, token));
                  ...
                  while (1) {
                    switch (_context13.prev = _context13.next) {
                      ...
                      case 3:
                        ...
                        return _context13.abrupt("return", [action]);

                      case 6:
                        return _context13.abrupt("return", mdLs.getCodeActions(document, params.range, params.context, token));
            ...
            connection.onCodeActionResolve( /*#__PURE__*/function () {
              var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(codeAction, token) {
                  ...
                  while (1) {
                    switch (_context14.prev = _context14.next) {
                      case 0:
                        ...
                        return _context14.abrupt("return", codeAction);
            ...
            connection.onDocumentHighlight( /*#__PURE__*/function () {
              var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(params, token) {
                var document;
                return regeneratorRuntime.wrap(function _callee15$(_context15) {
                  while (1) {
                    switch (_context15.prev = _context15.next) {
                      ...
                      case 3:
                        return _context15.abrupt("return", mdLs.getDocumentHighlights(document, params.position, token));
